...
export default function CTABanner({
  ...
  spot = "CTABanner",
  imageSrc,
  eyebrow = "Sentinel · Central Texas",
  badgeA = "AHJ Docs",
  badgeB = "Sprinkler",
  badgeC = "24/7*",
}: CTABannerProps) {
  ...
  return (
    <section className={styles.banner} aria-label="Call to action">
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <svg width="400" height="400" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l8 3v6c0 5.5-3.4 9.7-8 11-4.6-1.3-8-5.5-8-11V5l8-3zm0 2.2L6 6.1v4.9c0 4.2 2.5 7.6 6 8.8 3.5-1.2 6-4.6 6-8.8V6.1l-6-1.9z" opacity="0.85"/></svg>
      </motion.div>
