...
export default function ServiceCardComponent({
  cards,
  heading    = 'Complete Fire Protection Coverage',
  subheading = 'From emergency repairs to new alarms and sprinklers, Sentinel Fire Protection handles it all — on time, on price.',
