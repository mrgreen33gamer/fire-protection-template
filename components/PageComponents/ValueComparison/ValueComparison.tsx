...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Code-Compliant Installs · Inspection On-Time Guarantee', us: true, others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Sentinel Fire Protection vs. The Other Guys' }: ValueComparisonProps) {
  return (
