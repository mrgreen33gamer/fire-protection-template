...
const INDUSTRIES = [
  { slug: 'restaurants',  label: 'Restaurants & Hospitality', icon: faHouse },
  { slug: 'healthcare',   label: 'Healthcare Facilities',     icon: faHardHat },
  { slug: 'multifamily',  label: 'Multifamily Housing',       icon: faIndustry },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Fire protection programs — built for how your industry actually works.',
  disableLinks = false,
