            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed Sentinel Fire Protection technician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12549001111"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 900-1111', section: 'ContactForm-V1' })}>
                          Call (254) 900-1111
                        </a>
                      </span>
                    </div>
