...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Sentinel Fire Protection',
  address       = '1100 S 5th St, Waco, TX 76706',
  phone         = '(254) 900-1111',
  email         = 'hello@sentinelfiretx.com',
  googleMapsUrl = 'https://maps.google.com/?q=Sentinel+Fire+Protection+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed fire protection technicians.
          </p>
        </div>
