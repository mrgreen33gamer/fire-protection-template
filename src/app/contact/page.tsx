...
// Sentinel Fire Protection — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Fire Alarm Systems', 'Sprinkler Systems', 'Fire Extinguishers',
  'Kitchen Hood Suppression', 'Fire Monitoring', 'Annual Inspections',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 900-1111. We answer 7 days a week including evenings. For a genuine fire protection emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial fire protection systems?',
    answer: 'Yes — light commercial fire protection for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific system and location.',
  },
  {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Systems Protected</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@sentinelfiretx.com',
                  href:      'mailto:hello@sentinelfiretx.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1100 S 5th St, Waco TX 76706',
                  href:      'https://maps.google.com/?q=1100+S+5th+St+Waco+TX+76706',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why facilities choose Sentinel Fire Protection</p>
              {[
                'Flat-rate pricing — written quote before we start',
                'Code-Compliant Installs · Inspection On-Time Guarantee',
                'Licensed Fire Alarm Contractor · Bonded & Insured',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed Sentinel Fire Protection technician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549001111">(254) 900-1111</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 900-1111 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 900-1111"
        primaryLink="tel:+12549001111"
        secondaryText="Send a Text"
        secondaryLink="sms:+12549001111"
      />
