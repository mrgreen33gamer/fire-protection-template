    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Sentinel Fire Protection — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Practical fire protection safety tips, sprinkler systems repair guidance, and fire monitoring advice for Central Texas homeowners.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need a licensed fire protection technician in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been powering Waco-area homes and businesses with expert fire protection repair, sprinkler systems repair, and installations since 2001. Free estimate, no obligations.
            </p>
